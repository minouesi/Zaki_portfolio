!(function() {
        ...
        kt = function(t, e) {
            ...
            if ((r = c ? n : f ? n[s] || T(s, {}) : (n[s] || {}).prototype))
                for (o in e) {
                    if (
                        ((a = e[o]),
                            (i = t.noTargetGet ? (u = Tt(r, o)) && u.value : r[o]), !It(c ? o : s + (f ? "." : "#") + o, t.forced) && void 0 !== i)
                    ) {
            ...
            return function(u, s, c, f) {
                for (
                    var l,
                        ...
                        m = 0,
                        b = f || oe,
                        w = e ? b(u, y) : r ? b(u, 0) : void 0; y > m; m++
                )
    ...
    var nn = function() {
        for (
            var t, e = R(this), r = Qt(e.delete), n = !0, o = 0, i = arguments.length; o < i; o++
        )
    ...
    kt({ target: "Object", stat: !0 }, {
        ...
        kt({ target: "Object", stat: !0, sham: !i }, {
            getOwnPropertyDescriptors: function(t) {
                for (
                    var e, r, n = v(t), o = O.f, i = St(n), a = {}, u = 0; i.length > u;
    ...
    var Hi = function() {
        for (
            var t = R(this), e = Qt(t.add), r = 0, n = arguments.length; r < n; r++
        )
    ...
    var Lu = Dt("iterator"),
        ...
        function(t, e) {
            for (
                var r = Lt(t), n = arguments.length, o = 1, a = wt.f, u = s.f; n > o;
    ...
    Fr(
            ds, {
                ...
                getAll: function(t) {
                    ls(arguments.length, 1);
                    for (
                        var e = Qu(this).entries, r = t + "", n = [], o = 0; o < e.length; o++
                    )
                ...
                Rf(function() {
                    for (var o = e.value, i = 1 == e.state, a = 0; n.length > a;) {
                        ...
                        try {
                            l
                                ?
                                (i || (2 === e.rejection && tl(t, e), (e.rejection = 1)), !0 === l ?
                                    (u = o) :
            ...
            (this.text = function() {
                ...
                if (this._bodyArrayBuffer)
                    return Promise.resolve(
                        (function(t) {
                            for (
                                var e = new Uint8Array(t), r = new Array(e.length), n = 0; n < e.length; n++
                            )
